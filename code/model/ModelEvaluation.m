    ...
    methods
        ...
        function self = ModelEvaluation( name, setup, verbose )
            ...
            if verbose
                ...
                disp(['               Z Correlation = ' ...
                    num2str( self.TrainingCorrelations.ZCorrelation, '%.3f' )]);
                disp(['              XC Correlation = ' ...
                    num2str( self.TrainingCorrelations.XCCorrelation, '%.3f' )]);
                ...
                disp(['               Z Correlation = ' ...
                    num2str( self.TestingCorrelations.ZCorrelation, '%.3f' )]);
                disp(['              XC Correlation = ' ...
                    num2str( self.TestingCorrelations.XCCorrelation, '%.3f' )]);
            end
