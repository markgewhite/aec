...
setup.opt.objective = 'FisherError';
setup.opt.nEpochs = 1000;
...
varDef(22) = optimizableVariable( 'nEpochsPretraining', ...
        [0 500], ...
        'Type', 'integer', 'Optimize', 'log', 'Optimize', false );

varDef(23) = optimizableVariable( 'isInterdependent', ...
         ["false" "true"], ...
