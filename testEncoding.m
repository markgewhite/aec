...
for i = 1:nRuns
    ...
    testModel1 = fcModel( reconLoss, mmdLoss, ...
    ...
    myTrainer = trainer( testModel1, ...
                         setup.data.padValue, setup.data.padLoc, ...
                         setup.data.cLabels, ...
                         updateFreq=5 );

    testModel1 = myTrainer.train( testModel1, XNTrn, XNTrn, YTrn );

    testModel2 = myTrainer.train( testModel2, XTrn, XNTrn, YTrn );
